  ...
  return (
    <div className="min-h-[calc(100vh-73px)] flex items-center justify-center p-6 relative bg-slate-50">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white border border-slate-200 p-4 rounded-xl space-y-2.5 shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            >
              <div className="flex items-center space-x-1 text-xs font-semibold text-purple-700">
                ...
                <span className="truncate">Himanshi Kalra</span>
              </div>
              <div className="text-[10px] text-slate-500 font-mono mt-0.5">HR Director</div>
            </button>
            ...
            >
              <div className="flex items-center space-x-1 text-xs font-semibold text-indigo-700">
                ...
                <span className="truncate">Sakshi Kumari</span>
              </div>
              <div className="text-[10px] text-slate-500 font-mono mt-0.5">Cloud Architect</div>
            </button>

            <button
              onClick={() => handleQuickLogin('emily@company.com')}
              className="p-2.5 rounded bg-slate-50 hover:bg-slate-100 border border-slate-200 text-left transition"
            >
              <div className="flex items-center space-x-1 text-xs font-semibold text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                <span className="truncate">Ishita Mukherjee</span>
              </div>
              <div className="text-[10px] text-slate-500 font-mono mt-0.5">UX Lead</div>
            </button>
          </div>
        </div>
